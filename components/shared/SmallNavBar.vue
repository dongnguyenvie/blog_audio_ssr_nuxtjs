        ...
        <div v-for="(item, i) in group.children" :key="`${index}-${i}`" class="pl-3 px-2 hover:bg-gray-200">
          <div>
            <a
              ...
              :class="[
                'flex flex-col items-center text-center  hover:text-gray-900 font-medium text-gray-900 py-2',
                {
      ...
      <div v-for="category in categories" :key="category.id" class="pl-3 px-2 hover:bg-gray-200">
        <div>
          <nuxt-link
            ...
            tag="a"
            class="flex flex-col items-center text-center hover:text-gray-900 font-medium text-gray-900 py-2"
          >
